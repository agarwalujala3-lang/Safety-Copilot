...
1. Frontend (live): `http://safety-copilot-ui-119944160349-20260410111252.s3-website.ap-south-1.amazonaws.com`
2. Privacy policy (live): `http://safety-copilot-ui-119944160349-20260410111252.s3-website.ap-south-1.amazonaws.com/privacy-policy.html`
3. Backend API (primary): `https://6rpyxxaw7c.execute-api.ap-south-1.amazonaws.com/api/v1`
4. Backend health (primary): `https://6rpyxxaw7c.execute-api.ap-south-1.amazonaws.com/health`
5. Backend Lambda URL (legacy, still reachable): `https://yegajpcluzigy6ffamfvwopxry0ejyao.lambda-url.ap-south-1.on.aws/api/v1`
